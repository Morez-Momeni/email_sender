...
The message is then sent to all saved recipients.
...
The program handles the single-recipient sending workflow from the terminal.
...
This mode allows an HTML template to be selected and sent as an HTML email.
...
| `--receive`   | Fetch and display received emails using IMAP |
...
* [ ] Scheduled sending
* [ ] Email search
* [ ] Better HTML template management
